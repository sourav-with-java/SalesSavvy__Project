...
const AdminDashboard = () => {
  ...
  const handleDeleteProductSubmit = async ({ productId }) => {
    try {
      const response = await fetch(
        "http://localhost:9000/admin/products/delete",
        {
          method: "DELETE",
          credentials: "include",
          headers: {
  ...
  const getUserDetails = async (userId) => {
    try {
      const response = await fetch(
        `http://localhost:9000/admin/user/getbyid?userId=${userId}`,
        {
          method: 'GET',
          credentials: 'include',
          headers: {
  ...
  const modifyUser = async (userData) => {
    try {
      ...
      if (!response.ok) {
        const errorData = await response.json();
        throw new Error(errorData.error || 'Failed to modify user');
      }
  ...
  const handleModifyUserSubmit = async (data) => {
    if (!data.username) {
      ...
      try {
        ...
        const updatedUser = await modifyUser(data);
        setResponse({ 
          user: updatedUser,
  ...
  const handleMonthlyBusiness = async (data) => {
    try {
      const response = await fetch(
        `http://localhost:9000/admin/business/monthly?month=${data?.month}&year=${data?.year}`,
        {
          method: "GET",
          credentials: "include",
          headers: {
  ...
  const handleDailyBusiness = async (data) => {
    try {
      const response = await fetch(
        `http://localhost:9000/admin/business/daily?date=${data?.date}`,
        {
          method: "GET",
          credentials: "include",
          headers: {
  ...
  const handleYearlyBusiness = async (data) => {
    try {
      const response = await fetch(
        `http://localhost:9000/admin/business/yearly?year=${data?.year}`,
        {
          method: "GET",
          credentials: "include",
          headers: {
  ...
  const handleOverallBusiness = async () => {
    try {
      const response = await fetch(
        `http://localhost:9000/admin/business/overall`,
        {
          method: "GET",
          credentials: "include",
          headers: {
